        ...
        PromptMessage(
            ...
            content=TextContent(
                ...
                text=f"""Build a sample application that integrates the existing log framework code.
                        CONTEXT:
                        - Log framework code is available at: C:\\Users\\User1\\Project\\DEMO\\welog
                        ...
                        INSTRUCTIONS:
                        1. Examine the log framework code at C:\\Users\\User1\\Project\\DEMO\\welog to understand its API and capabilities
